...
<div id="main-container">
  ...
  <div id="main-content">
    ...
    echo "<div id='label-row'><div class='label'>Product Name</div><div class='label'>Quantity</div><div class='label'>Product Type</div><div class='label'>Price</div>";
  ...
  <div id="right-column"> This is the footer. </div>
</div>
